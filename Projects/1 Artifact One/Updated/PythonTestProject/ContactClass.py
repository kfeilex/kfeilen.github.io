# Author: Kenny F.
# Date: 10/21/2022
# Description: This project represents a section of a larger project that was originally in java
# I rewrote this project in Python to show how to use unit testing in different languages
