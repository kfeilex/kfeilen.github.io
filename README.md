...
I had a few different experiences working with and learning data structures and as software engineering. One fun project was creating a full stack webserver in CS 340. I got to setup and manage access to the database in MongoDB, write the CRUD file to call the database and the implement that in a web server. CS 330 Computational Graphics and Visualization, was also a lot of fun. I developed my own OpenGL environment, utilizing data structures and memory structures VBO's and VAO's. However, the most relevant projects to show skillset are the three included below.

One last class that was very influential on my path was CS 200: Cybersecurity Foundations. This class opened my eyes to the world of cyber security. I learned about threat actors and the different ways they will attempt to compromise software and networks to obtain data. I saw the implications of not securing passwords and not configuring networks correctly in this class. I was given the opportunity to compromise a remote system in a lab environment and exploit those types of vulnerabilities, then provide a recap of what vulnerabilities were found on the network. This experience exposed me to a real-world use case of why the CIA triad, confidentiality, integrity, and availability, is so important. I have always ensured that passwords I use are complex. However, after this class I learned to never leave passwords hardcoded into leftover test files or where they can be easily found on a system. I also make sure to restrict access when I write code so that users only have the required data they need, while making sure that data is available when they need it. I was able to utilize this during my full stack project in CS 340 I mentioned above. This will make sure data is not removed by someone who should not be able to, keeping with a security mindset and data integrity. I talk more about security in the final part of this portfolio when I review my SQL project.

Additionally, I have included three projects in this portfolio that I will be reviewing in-depth below, where I go over the following. Software Design and Engineering, where I implement testing in Python. Algorithms and data structures, where I update my C++ Binary Search Tree, and Databases, where I implement MySQL Triggers. The first project below takes a Java program and implements sections of that program in Python to utilizing testing in Python. This project relates to the importance of testing code and how to write tests. The second project is my binary search tree which will showcase algorithms and how they can be used to quickly search data. Finally, this portfolio will conclude with a MySQL demonstration of how triggers can be utilized in the real world for both time savings and security use cases.

## Code Review:
This section of my portfolio consists of my code review which I have linked below. This code review as well as the comments throughout my projects and examples given in the professional self-assessment show how I met the requirements for CS-499-01. Employ strategies for building collaborative environments that enable diverse audiences to support organizational decision making in the field of computer science. For each of my three projects I reviewed their functionality before any enhancements, performed an analysis of its code and then made decisions on updates or changes that would enhance the overall project. Taking a deeper look into the projects I have created line by line allowed me to see what each project currently does and how it preforms those tasks. This allowed me to see other ways that I could improve the overall functionality in the future. Which is a vital step to ensuring my code meets the needs of stakeholders and is written as efficiently as possible. Preforming code reviews are a necessary step in the software development lifecycle (SDL). One best practice I learned from feedback I received was to always use a checklist to ensure that nothing is overlooked. This will make sure you review the structure, documentation, variables, loops, testing and more. This also can allow for a second set of eyes to review your code, helping to ensure the deliverable will meet the stakeholder’s requirements. When transitioning into team environments, understanding the importance of code reviews and the collaboration they build among a team is vital. My code review is linked below.
...
This project demonstrates how I met the requirements for CS-499-04. Demonstrating an ability to use well-founded and innovative techniques, skills, and tools in computing practices for the purpose of implementing computer solutions that deliver value and accomplish industry-specific goals. I wrote a contact class in Python and set constraints on each of the variables based on the past requirements. Then I successfully implemented ten tests on the contact class to ensure that the variables provided were within the bounds of the requirements. Demonstrating an ability to work with and write tests shows my ability to employ testing techniques and also relates back to using well-founded and innovative techniques to meet industry goals. 

Working with this program was fun yet I had some challenges along the way, mainly with overthinking the problem. This is one thing that I struggled with occasionally in development, overthinking what I am trying to accomplish. I found once I took a step back, I could look at the problem from a different angle and move forward. I found that writing tests in Python instead of Java was more straight forward for me and I ended up with code. I did struggle to get pytest working on my local machine and ended up utilizing unit tests in Python instead.
...
Utilizing MySQL to create, modify and use triggers to monitor tables in this project and to create a log file, show my how I am meeting the CS-499-04 requirements. To use well-founded and innovative techniques, skills, and tools in computing practices for the purpose of implementing computer solutions that deliver value and accomplish industry-specific goals. I created and setup tables with data to serve as a baseline environment. I then setup two different triggers that each perform a different task. One that backs-up deleted entries, the second keeps a running total of a database without needing to search the table every time. By using a trigger to have a table keep a running total of orders in the system, I have accounted for different industry needs like time constraints on obtaining information. 
